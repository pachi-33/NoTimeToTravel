...
Page({
  data: {
    noteList: [{
      ...
      },
      {
        ...
        coverImg: "https://res.wx.qq.com/op_res/7_miJnK0wxIrh5bV2QqvYZB1p48LLH-Pc7Rzr4nN0YF-uZg7FW7zksw_Kjp0BNDHcZp9R9SRKbg0rA1HBaeK3Q",
        authorNickname: "MAple",
        authorAvatar: "https://res.wx.qq.com/op_res/7_miJnK0wxIrh5bV2QqvYRu0VRyVvePJ4pB4_Dvj0ytF-ovjQzMl6WMLyuCeKk3579HNjKLIeNrHE7OprTBx5w",
        likeNume: 100,
        status: "disapproved",
      ...
      },
      {
        noteId: 3,
        title: "推荐三种上海美食",
        coverImg: "https://res.wx.qq.com/op_res/7_miJnK0wxIrh5bV2QqvYRu0VRyVvePJ4pB4_Dvj0ytF-ovjQzMl6WMLyuCeKk3579HNjKLIeNrHE7OprTBx5w",
        authorNickname: "MAple",
        authorAvatar: "https://res.wx.qq.com/op_res/7_miJnK0wxIrh5bV2QqvYRu0VRyVvePJ4pB4_Dvj0ytF-ovjQzMl6WMLyuCeKk3579HNjKLIeNrHE7OprTBx5w",
        likeNume: 100,
        status: "approved",
  ...
  setNoteList: async function () {
    const newList = await this.getMyNoteListWithStatus();
    if (newList.length !== 0) {
